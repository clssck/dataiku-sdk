	...
	it("plans fixed mutation endpoints with exact methods and payloads without contacting DSS", async () => {
		...
		await withCliServer((req, res,) => {
			...
			const cases = [
				...
				{
					name: "dashboard create accepts JSON name and listed flag",
					argv: [
						"dashboard",
						"create",
						"--data",
						'{"name":"From data","pages":[]}',
						"--listed",
						"true",
						"--plan",
						"--project-key",
					...
					expected: {
						...
						action: "create",
						method: "POST",
						endpoint: "/public/api/projects/TEST/dashboards/",
						payload: { name: "From data", pages: [], listed: true, },
					},
				},
				{
					name: "dashboard update keeps JSON name and adds listed flag",
					argv: [
						"dashboard",
						"update",
						"dash-1",
					...
					expected: {
						...
						payload: { name: "Kept from data", listed: false, },
					},
				},
				{
					name: "bundle export",
